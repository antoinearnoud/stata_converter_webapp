# to run this program, you need to install streamlit and pandas
...
st.markdown('Desktop application available for <a href="https://www.github.com/antoinearnoud/stata_converter"> Mac </a>', unsafe_allow_html=True)
